 ...
 */
public class Padding2DLayer extends Layer {
    ...
    public Padding2DLayer() {
    }

    public Padding2DLayer(int padding) {
        super(Padding2DLayer.class.getSimpleName());
        this.pTop = padding;
    ...
    public Padding2DLayer(String name, int padding) {
        super(Padding2DLayer.class.getSimpleName());
        this.pTop = padding;
        this.pBottom = padding;
        this.pLeft = padding;
    ...
    public Padding2DLayer(int paddingX, int paddingY) {
        super(Padding2DLayer.class.getSimpleName());
        this.pTop = paddingY;
        this.pBottom = paddingY;
        this.pLeft = paddingX;
        this.pRight = paddingX;
    }

    public Padding2DLayer(String name, int paddingX, int paddingY) {
        super(Padding2DLayer.class.getSimpleName());
        this.pTop = paddingY;
        this.pBottom = paddingY;
        this.pLeft = paddingX;
