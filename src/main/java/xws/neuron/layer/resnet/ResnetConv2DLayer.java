 ...
 */
public class ResnetConv2DLayer extends Layer {
    ...
    public ResnetConv2DLayer() {
    }

    public ResnetConv2DLayer(int padding) {
        super(ResnetConv2DLayer.class.getSimpleName());
    }

    public ResnetConv2DLayer(String name, int padding) {
        super(ResnetConv2DLayer.class.getSimpleName());
        setName(name);
    }

    //构造函数时，传入filters的构造
    public ResnetConv2DLayer(int pTop, int pBottom, int pLeft, int pRight) {
        super(ResnetConv2DLayer.class.getSimpleName());
    }

    public ResnetConv2DLayer(String name, int pTop, int pBottom, int pLeft, int pRight) {
        super(ResnetConv2DLayer.class.getSimpleName());
        setName(name);
