...
public class FilterLayer extends Layer {
    ...
    public FilterLayer(int total, int height, int width, int strideX, int strideY, int padding) {
        super("filter");
        this.height = height;
        this.width = width;
    ...
    public FilterLayer(String name, String activationType, int total, int height, int width, int strideX, int strideY, int padding) {
        super("filter");
        setName(name);
    ...
    public FilterLayer(String name, String activationType, int total, int height, int width, int strideX, int strideY, int padding, double lambda) {
        super("filter");
        setName(name);
        setActivationType(activationType);
        this.height = height;
